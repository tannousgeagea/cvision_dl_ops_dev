            ...
            "data": [
                {
                    ...
                    "thumbnail": "http://localhost:29083" + ProjectImage.objects.filter(project=project).first().image.image_file.url if ProjectImage.objects.filter(project=project).exists() else None,
